...
py::class_<PolyLineType> PyPolyLine(py::module_ m, const char *name) {
    return py::class_<PolyLineType>(m, name)
        ...
        .def("scale", py::overload_cast<const double>(&PolyLineType::scale, py::const_))
        .def("scale", py::overload_cast<const VectorClass&>(&PolyLineType::scale, py::const_))
        .def("move", &PolyLineType::move)
        .def("add", &PolyLineType::add)
        .def("sub", &PolyLineType::sub)
        .def("scale_nodes", &PolyLineType::scale_nodes)
        .def("__mul__", py::overload_cast<const double>(&PolyLineType::scale, py::const_))
        .def("__mul__", py::overload_cast<const VectorClass&>(&PolyLineType::scale, py::const_))
        .def(py::self + py::self)
